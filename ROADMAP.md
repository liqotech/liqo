...
```mermaid
gantt
    title Liqo Release Schedule
    dateFormat  YYYY-MM-DD
    axisFormat %B %Y
    section Releases
    v1.0.0-rc3 development :active,    rc3-dev,    2024-10-04,    2024-12-20
    v1.0.0-rc3             :milestone, rc3,        after rc3-dev, 2024-12-20
    v1.0.0 consolidation   :           final-cons, after rc3,     until final
    v1.0.0                 :milestone, final,      2025-06-01,    2025-06-01
```
