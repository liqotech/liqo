...
// Package envvars is the package that builds the environment variables that kubernetes provides
// to the containers run by it. The content of this package is copied from k8s.io/kubernetes,
// even if it isn't (exactly) a 1-1 copy. This exists so we do not have to import from k8s.io/kubernetes
// which is currently problematic. Original import path: "k8s.io/kubernetes/pkg/kubelet/envvars"
package envvars
...
// This function is copied verbatim from "k8s.io/kubernetes/pkg/apis/core/v1/helper"
