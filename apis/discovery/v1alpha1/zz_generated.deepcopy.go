...
func (in *ForeignClusterSpec) DeepCopyInto(out *ForeignClusterSpec) {
	*out = *in
	...
	in.FullPeering.DeepCopyInto(&out.FullPeering)
	out.InducedPeering = in.InducedPeering
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FullPeering) DeepCopyInto(out *FullPeering) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FullPeering.
func (in *FullPeering) DeepCopy() *FullPeering {
	if in == nil {
		return nil
	}
	out := new(FullPeering)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InducedPeering) DeepCopyInto(out *InducedPeering) {
	*out = *in
	out.OriginClusterIdentity = in.OriginClusterIdentity
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InducedPeering.
func (in *InducedPeering) DeepCopy() *InducedPeering {
	if in == nil {
		return nil
	}
	out := new(InducedPeering)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Neighborhood) DeepCopyInto(out *Neighborhood) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Neighborhood.
func (in *Neighborhood) DeepCopy() *Neighborhood {
	if in == nil {
		return nil
	}
	out := new(Neighborhood)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *Neighborhood) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NeighborhoodList) DeepCopyInto(out *NeighborhoodList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]Neighborhood, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NeighborhoodList.
func (in *NeighborhoodList) DeepCopy() *NeighborhoodList {
	if in == nil {
		return nil
	}
	out := new(NeighborhoodList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NeighborhoodList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NeighborhoodSpec) DeepCopyInto(out *NeighborhoodSpec) {
	*out = *in
	if in.NeighborsList != nil {
		in, out := &in.NeighborsList, &out.NeighborsList
		*out = make(map[string]Neighbor, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NeighborhoodSpec.
func (in *NeighborhoodSpec) DeepCopy() *NeighborhoodSpec {
	if in == nil {
		return nil
	}
	out := new(NeighborhoodSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NeighborhoodStatus) DeepCopyInto(out *NeighborhoodStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NeighborhoodStatus.
func (in *NeighborhoodStatus) DeepCopy() *NeighborhoodStatus {
	if in == nil {
		return nil
	}
	out := new(NeighborhoodStatus)
	in.DeepCopyInto(out)
	return out
}
