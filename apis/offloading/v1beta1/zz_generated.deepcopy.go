...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomResourceReflectorConfig) DeepCopyInto(out *CustomResourceReflectorConfig) {
	*out = *in
	out.ReflectorConfig = in.ReflectorConfig
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomResourceReflectorConfig.
func (in *CustomResourceReflectorConfig) DeepCopy() *CustomResourceReflectorConfig {
	if in == nil {
		return nil
	}
	out := new(CustomResourceReflectorConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualNodeStatus) DeepCopyInto(out *VirtualNodeStatus) {
	*out = *in
	...
	if in.EffectiveOffloadingPatch != nil {
		in, out := &in.EffectiveOffloadingPatch, &out.EffectiveOffloadingPatch
		*out = new(OffloadingPatch)
		(*in).DeepCopyInto(*out)
	}
	if in.EffectiveCreateNode != nil {
		in, out := &in.EffectiveCreateNode, &out.EffectiveCreateNode
		*out = new(bool)
		**out = **in
	}
	if in.EffectiveDisableNetworkCheck != nil {
		in, out := &in.EffectiveDisableNetworkCheck, &out.EffectiveDisableNetworkCheck
		*out = new(bool)
		**out = **in
	}
}
...
func (in *VkOptionsTemplateSpec) DeepCopyInto(out *VkOptionsTemplateSpec) {
	*out = *in
	...
	if in.CustomResources != nil {
		...
		*out = make([]CustomResourceReflectorConfig, len(*in))
		copy(*out, *in)
	}
