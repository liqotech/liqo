...
func checkAdvertisement(adv advertisementv1beta1.Advertiser) advertisementv1beta1.Advertiser {
...
func createFromYaml(r *AdvertiserReconciler, ctx context.Context, log logr.Logger, filename string, kind string) error {
...
//		Kind:     "ClusterRole",
//		Name:     "cluster-admin",nodecreator
//	},
//}
//
