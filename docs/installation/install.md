...
services to expose directly a remote pod is an [anti-pattern](https://github.com/kubernetes/enhancements/tree/master/keps/sig-multicluster/1645-multi-cluster-services-api#service-types).
```
