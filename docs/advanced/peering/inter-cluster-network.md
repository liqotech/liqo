...
## Setup the inter-cluster network via liqoctl network
...
More info about the declarative setup of the network can he found [here](./peering-via-cr.md#declarative-network-configuration).
