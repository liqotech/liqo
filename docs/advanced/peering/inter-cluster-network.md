...
```{admonition} Note
If the status return **Error** check the FAQ section [Debug gateway-to-gateway communication issues](../../faq/faq.md#FAQDebugGatewayToGateway) to get an hint on how to solve the issue.
```
