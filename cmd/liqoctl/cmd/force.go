...
func newUnpeerForceCommand(ctx context.Context, f *factory.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Run: func(_ *cobra.Command, args []string) {
			...
			output.ExitOnErr(options.RunUnpeerForce(ctx))
		},
	}
...
func newForceCommand(ctx context.Context, f *factory.Factory) *cobra.Command {
	...
	utils.AddCommand(maincmd, newUnpeerForceCommand(ctx, f))
