...
This command allows a consumer cluster to communicate and obtain slices of resources
from a remote provider cluster. At the end of the process, the consumer cluster will
...
Examples:
  $ {{ .Executable }} authenticate my-provider-cluster
`
