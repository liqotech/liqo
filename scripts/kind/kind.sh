...
kind delete clusters liqo1 liqo2
...
kubectl label no liqo1-control-plane liqonet.liqo.io/gateway=true
...
kubectl label no liqo2-control-plane liqonet.liqo.io/gateway=true
