...
| ipam.externalCIDR | string | `"10.70.0.0/16"` | The subnet used for the external CIDR. Deprecated: used as fallback if externalCIDRs is empty. |
| ipam.externalCIDRs | list | `[]` | The subnets used for the external CIDR. |
...
| ipam.podCIDR | string | `""` | The subnet used by the pods in your cluster, in CIDR notation (e.g., 10.0.0.0/16). Deprecated: used as fallback if podCIDRs is empty. |
| ipam.podCIDRs | list | `[]` | The subnets used by the pods in your cluster, in CIDR notation. |
