...
| controllerManager.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/liqo-controller-manager"` | Image repository for the controller-manager pod. |
...
| crdReplicator.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/crd-replicator"` | Image repository for the crdReplicator pod. |
...
| ipam.internal.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/ipam"` | Image repository for the IPAM pod. |
...
| liqo-crds.crdUpgrade.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/liqo-crd-upgrade"` | Image repository for the CRD upgrade job. NOTE: This image only supports linux/amd64 and linux/arm64 platforms (arm/v7 is not supported). |
...
| metricAgent.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/metric-agent"` | Image repository for the metricAgent pod. |
| metricAgent.image.version | string | `""` | Custom version for the metricAgent image. If not specified, the global tag is used. |
| metricAgent.initContainer.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/cert-creator"` | Image repository for the init container of the metricAgent pod. |
...
| networking.apiServerAccessThroughEndpointSlices | bool | `false` | Access remote API server through its Kubernetes service EndpointSlices instead of its ClusterIP. This is useful when the consumer CNI is preventing the access to the remote API server through its ClusterIP service. When enabled, the consumer cluster will access the remote API server through the endpointslices of the Kubernetes service. |
...
| networking.fabric.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/fabric"` | Image repository for the fabric pod. |
...
| networking.gatewayTemplates | object | `{"container":{"gateway":{"image":{"name":"us-docker.pkg.dev/castai-hub/library/liqo/gateway","version":""},"resources":{"limits":{},"requests":{}}},"geneve":{"image":{"name":"us-docker.pkg.dev/castai-hub/library/liqo/gateway/geneve","version":""},"resources":{"limits":{},"requests":{}}},"wireguard":{"image":{"name":"us-docker.pkg.dev/castai-hub/library/liqo/gateway/wireguard","version":""},"resources":{"limits":{},"requests":{}}}},"nftablesMonitor":true,"ping":{"interval":"2s","lossThreshold":5,"updateStatusInterval":"10s"},"pod":{"priorityClassName":"","tolerations":[]},"replicas":1,"routeMonitor":true,"server":{"service":{"allocateLoadBalancerNodePorts":"","annotations":{}}},"wireguard":{"implementation":"kernel","preserveClientEndpoint":true}}` | Set the options for the default gateway (server/client) templates. The default templates use a WireGuard implementation to connect the gateway of the clusters. These options are used to configure only the default templates and should not be considered if a custom template is used. |
| networking.gatewayTemplates.container.gateway.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/gateway"` | Image repository for the gateway container. |
...
| networking.gatewayTemplates.container.geneve.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/gateway/geneve"` | Image repository for the geneve container. |
...
| networking.gatewayTemplates.container.wireguard.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/gateway/wireguard"` | Image repository for the wireguard container. |
...
| offloading.runtimeClass.nodeSelector | object | `{"enabled":true,"labels":{"omni.cast.ai/type":"virtual-node"}}` | Node selector for the runtime class. |
| offloading.runtimeClass.nodeSelector.labels | object | `{"omni.cast.ai/type":"virtual-node"}` | Labels for the node selector. |
| offloading.runtimeClass.tolerations | object | `{"enabled":true,"tolerations":[{"effect":"NoExecute","key":"virtual-node.omni.cast.ai/not-allowed","operator":"Exists"}]}` | Tolerations for the runtime class. |
| offloading.runtimeClass.tolerations.tolerations | list | `[{"effect":"NoExecute","key":"virtual-node.omni.cast.ai/not-allowed","operator":"Exists"}]` | Tolerations for the tolerations. |
...
| proxy.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/proxy"` | Image repository for the proxy pod. |
...
| telemetry.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/telemetry"` | Image repository for the telemetry pod. |
...
| uninstaller.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/uninstaller"` | Image repository for the uninstaller pod. |
...
| webhook.image.name | string | `"us-docker.pkg.dev/castai-hub/library/liqo/webhook"` | Image repository for the webhook pod. |
