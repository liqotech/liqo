...
| networking.gatewayTemplates.wireguard.preserveClientEndpoint | bool | `false` | Preserve the existing peer endpoint when configuring the server-side WireGuard device. |
