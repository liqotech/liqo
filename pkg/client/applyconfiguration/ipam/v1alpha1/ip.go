...
func (b *IPApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *IPApplyConfiguration) WithStatus(value *IPStatusApplyConfiguration) *IPApplyConfiguration {
	b.Status = value
	return b
}
