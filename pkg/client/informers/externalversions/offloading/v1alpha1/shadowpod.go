	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OffloadingV1alpha1().ShadowPods(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OffloadingV1alpha1().ShadowPods(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *shadowPodInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&offloadingv1alpha1.ShadowPod{}, f.defaultInformer)
}
