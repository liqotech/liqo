...
type VkOptionsTemplateInformer interface {
	...
	Lister() v1alpha1.VkOptionsTemplateLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OffloadingV1alpha1().VkOptionsTemplates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OffloadingV1alpha1().VkOptionsTemplates(namespace).Watch(context.TODO(), options)
			},
		},
		&offloadingv1alpha1.VkOptionsTemplate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *vkOptionsTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&offloadingv1alpha1.VkOptionsTemplate{}, f.defaultInformer)
}

func (f *vkOptionsTemplateInformer) Lister() v1alpha1.VkOptionsTemplateLister {
	return v1alpha1.NewVkOptionsTemplateLister(f.Informer().GetIndexer())
}
