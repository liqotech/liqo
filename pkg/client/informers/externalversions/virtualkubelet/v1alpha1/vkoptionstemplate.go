	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VirtualkubeletV1alpha1().VkOptionsTemplates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VirtualkubeletV1alpha1().VkOptionsTemplates(namespace).Watch(context.TODO(), options)
			},
		},
		&virtualkubeletv1alpha1.VkOptionsTemplate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *vkOptionsTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&virtualkubeletv1alpha1.VkOptionsTemplate{}, f.defaultInformer)
}
