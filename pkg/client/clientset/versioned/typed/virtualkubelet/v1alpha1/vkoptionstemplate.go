...
type VkOptionsTemplateInterface interface {
	Create(ctx context.Context, vkOptionsTemplate *v1alpha1.VkOptionsTemplate, opts v1.CreateOptions) (*v1alpha1.VkOptionsTemplate, error)
	Update(ctx context.Context, vkOptionsTemplate *v1alpha1.VkOptionsTemplate, opts v1.UpdateOptions) (*v1alpha1.VkOptionsTemplate, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.VkOptionsTemplate, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.VkOptionsTemplateList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VkOptionsTemplate, err error)
...
func newVkOptionsTemplates(c *VirtualkubeletV1alpha1Client, namespace string) *vkOptionsTemplates {
...
func (c *vkOptionsTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VkOptionsTemplate, err error) {
	result = &v1alpha1.VkOptionsTemplate{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *vkOptionsTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VkOptionsTemplateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VkOptionsTemplateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vkoptionstemplates").
...
func (c *vkOptionsTemplates) Create(ctx context.Context, vkOptionsTemplate *v1alpha1.VkOptionsTemplate, opts v1.CreateOptions) (result *v1alpha1.VkOptionsTemplate, err error) {
	result = &v1alpha1.VkOptionsTemplate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vkoptionstemplates").
...
func (c *vkOptionsTemplates) Update(ctx context.Context, vkOptionsTemplate *v1alpha1.VkOptionsTemplate, opts v1.UpdateOptions) (result *v1alpha1.VkOptionsTemplate, err error) {
	result = &v1alpha1.VkOptionsTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vkoptionstemplates").
...
func (c *vkOptionsTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VkOptionsTemplate, err error) {
	result = &v1alpha1.VkOptionsTemplate{}
