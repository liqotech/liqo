...
func (c *namespaceMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.NamespaceMap, err error) {
	result = &v1beta1.NamespaceMap{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *namespaceMaps) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.NamespaceMapList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.NamespaceMapList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("namespacemaps").
...
func (c *namespaceMaps) Create(ctx context.Context, namespaceMap *v1beta1.NamespaceMap, opts v1.CreateOptions) (result *v1beta1.NamespaceMap, err error) {
	result = &v1beta1.NamespaceMap{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("namespacemaps").
...
func (c *namespaceMaps) Update(ctx context.Context, namespaceMap *v1beta1.NamespaceMap, opts v1.UpdateOptions) (result *v1beta1.NamespaceMap, err error) {
	result = &v1beta1.NamespaceMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("namespacemaps").
...
func (c *namespaceMaps) UpdateStatus(ctx context.Context, namespaceMap *v1beta1.NamespaceMap, opts v1.UpdateOptions) (result *v1beta1.NamespaceMap, err error) {
	result = &v1beta1.NamespaceMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("namespacemaps").
...
func (c *namespaceMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.NamespaceMap, err error) {
	result = &v1beta1.NamespaceMap{}
