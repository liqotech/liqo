...
func (c *shadowEndpointSlices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ShadowEndpointSlice, err error) {
	result = &v1beta1.ShadowEndpointSlice{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *shadowEndpointSlices) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ShadowEndpointSliceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ShadowEndpointSliceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("shadowendpointslices").
...
func (c *shadowEndpointSlices) Create(ctx context.Context, shadowEndpointSlice *v1beta1.ShadowEndpointSlice, opts v1.CreateOptions) (result *v1beta1.ShadowEndpointSlice, err error) {
	result = &v1beta1.ShadowEndpointSlice{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("shadowendpointslices").
...
func (c *shadowEndpointSlices) Update(ctx context.Context, shadowEndpointSlice *v1beta1.ShadowEndpointSlice, opts v1.UpdateOptions) (result *v1beta1.ShadowEndpointSlice, err error) {
	result = &v1beta1.ShadowEndpointSlice{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("shadowendpointslices").
...
func (c *shadowEndpointSlices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ShadowEndpointSlice, err error) {
	result = &v1beta1.ShadowEndpointSlice{}
