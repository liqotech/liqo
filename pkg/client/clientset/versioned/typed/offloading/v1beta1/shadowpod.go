...
func (c *shadowPods) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ShadowPod, err error) {
	result = &v1beta1.ShadowPod{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("shadowpods").
		Name(name).
...
func (c *shadowPods) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ShadowPodList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ShadowPodList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("shadowpods").
...
func (c *shadowPods) Create(ctx context.Context, shadowPod *v1beta1.ShadowPod, opts v1.CreateOptions) (result *v1beta1.ShadowPod, err error) {
	result = &v1beta1.ShadowPod{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("shadowpods").
...
func (c *shadowPods) Update(ctx context.Context, shadowPod *v1beta1.ShadowPod, opts v1.UpdateOptions) (result *v1beta1.ShadowPod, err error) {
	result = &v1beta1.ShadowPod{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("shadowpods").
...
func (c *shadowPods) UpdateStatus(ctx context.Context, shadowPod *v1beta1.ShadowPod, opts v1.UpdateOptions) (result *v1beta1.ShadowPod, err error) {
	result = &v1beta1.ShadowPod{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("shadowpods").
...
func (c *shadowPods) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ShadowPod, err error) {
	result = &v1beta1.ShadowPod{}
