...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.virtualkubeletV1alpha1, err = virtualkubeletv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.virtualkubeletV1alpha1 = virtualkubeletv1alpha1.NewForConfigOrDie(c)
