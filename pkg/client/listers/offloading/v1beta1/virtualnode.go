...
type VirtualNodeLister interface {
	...
	List(selector labels.Selector) (ret []*offloadingv1beta1.VirtualNode, err error)
...
type virtualNodeLister struct {
	listers.ResourceIndexer[*offloadingv1beta1.VirtualNode]
}

// NewVirtualNodeLister returns a new VirtualNodeLister.
func NewVirtualNodeLister(indexer cache.Indexer) VirtualNodeLister {
	return &virtualNodeLister{listers.New[*offloadingv1beta1.VirtualNode](indexer, offloadingv1beta1.Resource("virtualnode"))}
}

// VirtualNodes returns an object that can list and get VirtualNodes.
func (s *virtualNodeLister) VirtualNodes(namespace string) VirtualNodeNamespaceLister {
	return virtualNodeNamespaceLister{listers.NewNamespaced[*offloadingv1beta1.VirtualNode](s.ResourceIndexer, namespace)}
}
...
type VirtualNodeNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*offloadingv1beta1.VirtualNode, error)
