...
// resources pending deletion whose spec.targetRef matches the given apiVersion, kind, name and namespace.
...
func CleanupFirewallConfigurationBindings(ctx context.Context, cl client.Client,
	apiVersion, kind, name, namespace string, cleanupNftables bool) {
	...
	for i := range bindingList.Items {
		if MatchesTargetRef(&bindingList.Items[i].Spec.TargetRef, apiVersion, kind, name, namespace) {
