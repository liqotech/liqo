...
func (b *BindingCreatorBase) ReconcileBindings(ctx context.Context,
	fwcfg *networkingv1beta1.FirewallConfiguration, targets []networkingv1beta1.TargetReference) error {
...
func (b *BindingCreatorBase) ensureBinding(ctx context.Context,
	fwcfg *networkingv1beta1.FirewallConfiguration, bindingName string, target *networkingv1beta1.TargetReference) error {
	...
	if op != controllerutil.OperationResultNone {
		klog.Infof("FirewallConfigurationBinding %s/%s %s", fwcfg.Namespace, bindingName, op)
	}
	return nil
}
