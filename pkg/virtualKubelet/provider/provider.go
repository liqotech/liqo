...
func NewLiqoProvider(ctx context.Context, nodeName, foreignClusterID, homeClusterID, internalIP string, daemonEndpointPort int32,
	kubeconfig string, informerResyncPeriod time.Duration, ipamGRPCServer string, enableRemoteIpam bool, remotePodCidr string) (*LiqoProvider, error) {
	var err error
	...
	forge.InitForger(homeClusterID, enableRemoteIpam, remotePodCidr, mapper, virtualNodeNameOpt, grpcServerNameOpt, remoteClusterIDOpt)
