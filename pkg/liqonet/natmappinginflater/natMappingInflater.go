...
type Interface interface {
	...
	// Terminate is used to close the Inflater.
	Terminate()
}
...
type NatMappingInflater struct {
	...
	natMappingInformerStop chan struct{}
...
func NewInflater(dynClient dynamic.Interface) *NatMappingInflater {
	...
	inflater.startNatMappingWatcher()
	return inflater
}

func (inflater *NatMappingInflater) Terminate() {
	inflater.natMappingInformerStop <- struct{}{}
}
