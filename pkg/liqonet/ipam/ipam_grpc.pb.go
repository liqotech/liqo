...
type IpamClient interface {
	...
	GetRemotePodIP(ctx context.Context, in *GetRemotePodIPRequest, opts ...grpc.CallOption) (*GetRemotePodIPResponse, error)
}
...
func (c *ipamClient) GetRemotePodIP(ctx context.Context, in *GetRemotePodIPRequest, opts ...grpc.CallOption) (*GetRemotePodIPResponse, error) {
	out := new(GetRemotePodIPResponse)
	err := c.cc.Invoke(ctx, "/ipam/GetRemotePodIP", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IpamServer interface {
	...
	GetRemotePodIP(context.Context, *GetRemotePodIPRequest) (*GetRemotePodIPResponse, error)
...
func (UnimplementedIpamServer) GetRemotePodIP(context.Context, *GetRemotePodIPRequest) (*GetRemotePodIPResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRemotePodIP not implemented")
}
...
func _Ipam_GetRemotePodIP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRemotePodIPRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IpamServer).GetRemotePodIP(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ipam/GetRemotePodIP",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IpamServer).GetRemotePodIP(ctx, req.(*GetRemotePodIPRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Ipam_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetRemotePodIP",
			Handler:    _Ipam_GetRemotePodIP_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "ipam/ipam.proto",
}
