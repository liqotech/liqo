...
func (o *Options) setupKubenetOrAzureCNIOverlay(ctx context.Context, cluster *armcontainerservice.ManagedCluster) error {
	...
	o.ReservedSubnets = append(o.ReservedSubnets, *vnet.Properties.AddressPrefix)
...
func (o *Options) setupAzureCNI(ctx context.Context, cluster *armcontainerservice.ManagedCluster) error {
	...
	for i := range cluster.Properties.AgentPoolProfiles {
		...
		if vnet.Properties == nil || vnet.Properties.AddressPrefix == nil {
			return fmt.Errorf("subnet %q does not expose an address prefix", subnetName)
		}
		cidr := *vnet.Properties.AddressPrefix
