...
type ResourceReaderClient interface {
	ReadResources(ctx context.Context, in *ClusterIdentity, opts ...grpc.CallOption) (*ResourceList, error)
...
func (c *resourceReaderClient) ReadResources(ctx context.Context, in *ClusterIdentity, opts ...grpc.CallOption) (*ResourceList, error) {
...
type ResourceReaderServer interface {
	ReadResources(context.Context, *ClusterIdentity) (*ResourceList, error)
...
func (UnimplementedResourceReaderServer) ReadResources(context.Context, *ClusterIdentity) (*ResourceList, error) {
