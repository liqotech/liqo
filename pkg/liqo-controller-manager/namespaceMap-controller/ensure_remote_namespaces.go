...
func (r *NamespaceMapReconciler) createRemoteNamespace(ctx context.Context,
	remoteCluster v1alpha1.ClusterIdentity, remoteNamespaceName string) error {
	...
	// 1 - Try to get it
	if remoteNamespace, err = r.RemoteClients[remoteCluster.ClusterID].CoreV1().Namespaces().Get(ctx, remoteNamespaceName, metav1.GetOptions{}); err != nil {
...
func (r *NamespaceMapReconciler) ensureRemoteNamespacesExistence(
	...
	for localName, remoteName := range nm.Spec.DesiredMapping {
		var remoteCluster *v1alpha1.ForeignCluster
...
func (r *NamespaceMapReconciler) deleteRemoteNamespace(ctx context.Context,
	...
	return fmt.Errorf("the remote namespace '%s' inside the cluster '%s' is undergoing graceful termination", remoteNamespaceName, remoteCluster.ClusterName)
}
...
func checkRemoteNamespaceRoleBindings(ctx context.Context, cl kubernetes.Interface,
	remoteNamespaceName string, localCluster v1alpha1.ClusterIdentity) error {
	roleBindingLabelValue := liqoconst.RoleBindingLabelValuePrefix + "-" + localCluster.ClusterID
